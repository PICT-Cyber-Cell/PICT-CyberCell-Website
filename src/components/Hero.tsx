...
const Hero = () => {
  ...
  return (
    <div className="relative min-h-[calc(100vh-4rem)] flex flex-col justify-center items-center overflow-hidden px-4 sm:px-6 lg:px-8">
      ...
      <div className="relative z-10 w-full max-w-6xl mx-auto">
        <div className="text-center space-y-6">
          ...
          <div className="flex flex-wrap justify-center gap-4 sm:gap-6 mt-4">
            ...
            >
              <Button className="text-base sm:text-lg px-6 sm:px-8 py-2.5 sm:py-3">
                Join Now
              </Button>
            </a>
            <Link to="/contact">
      ...
      <div className="absolute top-1/4 left-[5%] w-16 sm:w-24 h-16 sm:h-24 bg-blue-500/10 rounded-full blur-xl animate-pulse" />
      <div className="absolute bottom-1/4 right-[5%] w-24 sm:w-32 h-24 sm:h-32 bg-cyan-500/10 rounded-full blur-xl animate-pulse delay-700" />
    </div>
  );
};
